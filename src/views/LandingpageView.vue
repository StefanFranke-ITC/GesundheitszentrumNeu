          ...
          <v-window-item :value="4">
            <v-container style="height: 80vh; overflow: scroll" >
              ...
              <v-row class="mx-auto justify-center mt-6 " style="width: 100%;">
                <v-col  v-for="bericht in reverseBerichte" style="max-height: 600px" :key="bericht.id" cols="11">

                  <div class="container1 ">
                    <div class="image">
                      <v-img :src="bericht.bild" alt="Beschreibung des Bildes " cover height="150px" width="150px"></v-img>
                    </div>
              ...
              <v-row style="width: 100%;" class="mt-5 d-flex justify-center" >
                <v-col class="d-flex justify-center" cols="12">
                  <v-card  class="buchBG pa-3" style=" overflow: scroll; height: 70vh; width: 90%">
                    ...
                    <br>
                    <p>
                      Die Chiropraktik beim Tier ist eine effektive und ganzheitliche Therapiemode, die darauf abzielt, die Gesundheit und das Wohlbefinden des Tieres durch die Korrektur von Wirbelsäulen- und Gelenkproblemen zu verbessern. Durch sanfte, präzise chiropraktische Justierungen werden Blockaden und Fehlstellungen im Körper des Tieres gelöst, wodurch die natürliche Balance und Funktion wiederhergestellt werden.
                      Die Wirkung der Chiropraktik beruht auf der Tatsache, dass das Nervensystem eine zentrale Rolle bei der Steuerung aller Körperfunktionen spielt. Durch Wirbelsäulen- und Gelenkfehlstellungen können Nervenimpulse blockiert oder gestört werden, was zu Schmerzen, Bewegungseinschränkungen und verschiedenen gesundheitlichen Problemen führen kann. Durch chiropraktische Justierungen werden diese Blockaden entfernt, wodurch die Kommunikation zwischen Gehirn, Nerven und Organen verbessert wird.
                      Die Chiropraktik beim Tier kann bei einer Vielzahl von Beschwerden wie Rückenschmerzen, Gelenkproblemen, Muskelschwäche, Verdauungsstörungen und sogar Verhaltensproblemen wirksam sein. Sie eignet sich sowohl zur Schmerzlinderung als auch zur Verbesserung der Beweglichkeit und Koordination. Chiropraktische Behandlungen sind in der Regel schmerzfrei und können bei Tieren aller Altersgruppen und Rassen angewendet werden.
                      Die Wirksamkeit der Chiropraktik beruht auf ihrer ganzheitlichen Herangehensweise, bei der nicht nur die Symptome behandelt werden, sondern auch die zugrunde liegenden Ursachen. Indem Ungleichgewichte im Körper korrigiert werden, wird die Selbstheilungskraft des Tieres stimuliert und dessen Gesundheit und Wohlbefinden auf natürliche Art und Weise gefördert. Es ist jedoch wichtig, einen zertifizierten und erfahrenen Tierchiropraktiker zu konsultieren, um die beste Betreuung für Ihr Tier zu gewährleisten.
                    </p>
                    <br>
                ...
                <v-col class="d-flex justify-center" cols="12">
                  <v-card  class="buchBG pa-3" style="overflow: scroll; height: 70vh; width: 90%">
                    ...
                    <p>
                      ...
                      Funktion und Energie, und behandelt somit nicht nur Symptome, sondern auch die Ursache des Problems.
                      Sie kann bei verschiedenen Beschwerden wie muskulären Verspannungen, Gelenkproblemen, Verdauungsstörungen
                      oder Verhaltensauffälligkeiten angewendet werden. Die osteopathische Behandlung ist in der Regel schmerzfrei
                      und für Tiere aller Altersgruppen geeignet. Sie kann eine wertvolle Ergänzung zur Schulmedizin sein und dazu beitragen,
                      die Gesundheit und das Wohlbefinden Ihres Tieres auf natürliche Weise zu fördern.
                    </p>

                    <v-row  style="width: 90%;" class="mt-6 ma-0 ">
                      <v-col cols="2" >
              ...
              <v-row style="width: 100%;" class="mt-5      d-flex justify-center" >
                <v-col class="d-flex justify-center" cols="12">
                  <v-card  class="buchBG pa-3" style="overflow: scroll; height: 70vh; width: 90%">
                    ...
                    <br>
                    <p>
                      Physiotherapie beim Tier ist eine wichtige Therapiemethode, die darauf abzielt, die Funktion und Beweglichkeit des Tieres wiederherzustellen, zu verbessern oder zu erhalten. Als ausgebildeter und geprüfter Physiotherapeut für Tiere erfasse ich die individuellen Bedürfnisse jedes Tieres, um ein maßgeschneidertes Behandlungsprogramm zu erstellen.
                      Die Hauptaufgabe der Physiotherapie ist es, die körperliche Rehabilitation und die Schmerzlinderung zu fördern. Durch verschiedene Behandlungstechniken wie Massage, manuelle Therapie, passive Bewegung, Dehnung und Übungen werden Schmerzen reduziert, Muskelverspannungen gelöst und die Gelenkfunktion verbessert.
                      Die Physiotherapie kann bei verschiedenen Problemen eingesetzt werden, z.B. nach Verletzungen, Operationen oder bei chronischen Erkrankungen. Sie hilft auch, altersbedingte Probleme wie Arthritis oder Wirbelsäulenprobleme zu bewältigen. Das Ziel ist es, die Mobilität zu verbessern, die Muskelfunktion zu stärken und die Lebensqualität des Tieres zu steigern.
                      Ein weiterer Schwerpunkt der Physiotherapie liegt auf der Prävention von Verletzungen und Erkrankungen. Durch gezieltes Training, Aufbau von Muskelkraft und Verbesserung der Balance wird die Belastbarkeit des Tieres erhöht, bevor es zu Problemen kommt.
                      Die Physiotherapie beim Tier kann als eigenständige Therapieform oder in Kombination mit anderen Behandlungsmethoden wie Osteopathie oder Akupunktur eingesetzt werden. Wichtig ist eine ganzheitliche Betrachtung des Tieres und eine enge Zusammenarbeit mit dem Tierbesitzer und anderen Fachleuten, um die bestmögliche Betreuung zu gewährleisten.
                      Meine Qualifikation als ausgebildeter und geprüfter Physiotherapeut für Tiere stellt sicher, dass Ihr Tier die bestmögliche Versorgung erhält. Ich stehe Ihnen gerne zur Verfügung, um gemeinsam das Behandlungsprogramm zu entwickeln, das den individuellen Bedürfnissen Ihres Tieres am besten entspricht.
                    </p>

                    <v-row style="width: 90%;" class="ma-0 mt-4">
                      <v-col cols="2" >
              ...
              <v-row style="width: 100%;" class="mt-5 d-flex justify-center" >
                <v-col class="d-flex justify-center" cols="12">
                  <v-card  class="buchBG pa-7" style="overflow: scroll; height: 70vh; width: 90%">
                    ...
                    <p class="mt-1">
                      Gesundheit ist von entscheidender Bedeutung, aber sie beginnt nicht nur mit äußerlichen Faktoren. Auch bei Tieren ist eine gesunde Ernährung der Grundstein für ein vitales und glückliches Leben. Leider können Allergien, Gelenkserkrankungen und sogar Kotwasser bei Pferden durch eine falsche Ernährung verursacht werden. Daher ist es von großer Bedeutung, sich mit diesem Thema genauer auseinanderzusetzen und Lösungen zu finden.
                    </p>
                    <br>
                    <h4 class="line">
                    ...
                    <p class="mt-1">
                      Eine falsche Ernährung kann bei Tieren zu allergischen Reaktionen führen. Unausgewogene Nahrung, zu viele künstliche Zusatzstoffe oder bestimmte Inhaltsstoffe können zu Sensibilisierungen führen. Dies kann sich in Symptomen wie Juckreiz, Hautrötungen, Durchfall oder Erbrechen äußern. Um Allergien zu vermeiden, ist eine natürliche und ausgewogene Ernährung, die den individuellen Bedürfnissen des Tieres entspricht, unerlässlich.
                    ...
                    <p class="mt-1">
                      ...
                      Eine unzureichende Ernährung kann auch zu wiederkehrenden Gelenkserkrankungen und Wirbelblockaden führen. Durch falsches Futter fehlen wichtige Nährstoffe, die für den Erhalt der Gelenkgesundheit und den reibungslosen Bewegungsablauf benötigt werden. Magen-Darm-Erkrankungen können zu Entzündungen führen, die wiederum die Gelenke und Wirbelsäule beeinflussen können. Durch gezielte Untersuchungen mit einem Labor können mögliche Zusammenhänge zwischen der Ernährung und solchen gesundheitlichen Problemen identifiziert werden.
                    </p>
                    <br>
                    ...
                    <p class="mt-1">
                      Kotwasser bei Pferden ist ein häufiges Problem, das oft mit der Ernährung in Verbindung gebracht wird. Ein Mangel an Ballaststoffen oder eine zu hohe Zufuhr von Stärke und Zucker kann die Darmflora negativ beeinflussen und zu Verdauungsstörungen führen. Eine angepasste Futterzusammensetzung, die auf den individuellen Bedarf des Pferdes abgestimmt ist, kann dazu beitragen, Kotwasser zu reduzieren und die Darmgesundheit zu verbessern.
                    ...
                    <p class="mt-1">
                      Eine artgerechte und ausgewogene Ernährung ist von großer Bedeutung, um Gesundheitsprobleme wie Allergien, Gelenkserkrankungen und Kotwasser bei Tieren zu vermeiden. Untersuchungen mit einem Labor können helfen, mögliche ernährungsbedingte Ursachen zu identifizieren. Sorgen wir mit einer bewussten und auf die individuellen Bedürfnisse abgestimmten Ernährung für das Wohlbefinden unserer tierischen Begleiter und geben ihnen die beste Chance auf ein gesundes und glückliches Leben.
...
export default {
  ...
  computed: {
    ...mapGetters(['preiseArray','produkteArray','seminarArray','berichteArray','videoArray']),
