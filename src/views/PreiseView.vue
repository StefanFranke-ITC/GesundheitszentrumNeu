...
export default {
  data: () => ({
    ...
    handynummer:'',
    preisArray:[
        {id:1, text:'alhfaognaepgjpaghaopjkfdafhjapegjpajgepj',ueberschrift:'Physiotherapie',dauer:'45 Min',bild: require('/src/assets/preisBild.png' ),preis:'300 Euro'},
        {id:2, text:'ljngkjsrnhnhlksdmflksngsl sgjslrngms ejfsrunh soeijgso',ueberschrift:'osteopathie',dauer:'20 Min',bild: require('/src/assets/preisBild.png' ),preis:'180 Euro'},
        {id:3, text:'ljngkjsrnhnhlksdmflksngsl sgjslrngms ejfsrunh soeijgso',ueberschrift:'osteopathie',dauer:'20 Min',bild: require('/src/assets/preisBild.png' ),preis:'180 Euro'},
        {id:4, text:'ljngkjsrnhnhlksdmflksngsl sgjslrngms ejfsrunh soeijgso',ueberschrift:'osteopathie',dauer:'20 Min',bild: require('/src/assets/preisBild.png' ),preis:'180 Euro'},
        {id:5, text:'ljngkjsrnhnhlksdmflksngsl sgjslrngms ejfsrunh soeijgso',ueberschrift:'osteopathie',dauer:'20 Min',bild: require('/src/assets/preisBild.png' ),preis:'180 Euro'},
        {id:6, text:'ljngkjsrnhnhlksdmflksngsl sgjslrngms ejfsrunh soeijgso',ueberschrift:'osteopathie',dauer:'20 Min',bild: require('/src/assets/preisBild.png' ),preis:'180 Euro'},
    ]
